...
function getConfigFile (name) {
  const pathToConfigFile = path.resolve('configuration', name)
...
// This function reads content of config/environments.json file.
...
module.exports = (on, config) => {
  ...
  return getConfigFile('environments.json')
    .then(content => {
      ...
      const consolidatedConfig = Object.assign(envSpecificConfig, unifiedCypressEnvVariables)
      return Object.assign(consolidatedConfig)
    })
}
