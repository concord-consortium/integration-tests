...
import * as plantGrowthHelper from '../../support/helpers/plantGrowthHelper';
import * as C from "../../support/constants";
import {PlantGrowthElements as e} from "../../support/elements/plant_growth_elements";
import {experimentConfigs} from "../../support/testdata/testdata_automatedtestactivity_plantgrowth_ap";
...
context("Verify Student Acitivty Player Activity Work Flow", () => {
  ...
  it("Verify student submitting answers", () => {
    ...
    STUDENTS.forEach(eachStudent => {
      ...
      cy.wait(15000);
      plantGrowthHelper.verifyInitialDisplay();
      experimentConfigs.forEach(c => {
          plantGrowthHelper.runExperiment(c);
          e.startNewTrial();
          plantGrowthHelper.verifyPreviousTrial(c);
