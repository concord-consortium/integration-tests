...
context("Verify admin can filter instructional materials", () => {
  ...
  it("Verify admin can create Grade 5 Math activity if not already present", () => {
    ...
    cy.get(searchAssignmentsPage.ACTIVITIES_LIST).then(($activities) => {
      if($activities.find(searchAssignmentsPage.MATERIAL_LIST_RESULT).length < 1) {
  ...
  it("Verify admin can create Temperature Sensor activity if not already present", () => {
    adminHelper.openSearchMaterialsPage();
    cy.get(searchAssignmentsPage.TXT_SEARCH_BAR).type(ACTIVITY3);
    cy.get(searchAssignmentsPage.BTN_GO).click();
  ...
  it("Verify admin can create Force Sensor activity if not already present", () => {
    adminHelper.openSearchMaterialsPage();
    cy.get(searchAssignmentsPage.TXT_SEARCH_BAR).type(ACTIVITY4);
    cy.get(searchAssignmentsPage.BTN_GO).click();
  ...
  it("Verify admin can create No Sensor activity if not already present", () => {
    adminHelper.openSearchMaterialsPage();
    cy.get(searchAssignmentsPage.TXT_SEARCH_BAR).type(ACTIVITY5);
    cy.get(searchAssignmentsPage.BTN_GO).click();
  ...
  it("Verify subject search filter for Math activity ", () => {
    adminHelper.openSearchMaterialsPage();
    cy.get(searchAssignmentsPage.TXT_SEARCH_BAR).type(ACTIVITY1);
    cy.get(searchAssignmentsPage.CHK_GRADE_LEVELS_5_6).uncheck();
    cy.get(searchAssignmentsPage.CHK_GRADE_LEVELS_7_8).uncheck();
    cy.get(searchAssignmentsPage.CHK_SUBJECT_MATH).check();
    cy.get(searchAssignmentsPage.CHK_SUBJECT_PHYSICS).uncheck();
    cy.get(searchAssignmentsPage.CHK_SUBJECT_PHYSICS).uncheck();
  ...
  it("Verify subject search filter for Physics activity", () => {
    ...
    cy.get(searchAssignmentsPage.CHK_GRADE_LEVELS_5_6).uncheck();
    cy.get(searchAssignmentsPage.CHK_GRADE_LEVELS_7_8).uncheck();
    cy.get(searchAssignmentsPage.CHK_SUBJECT_MATH).uncheck();
    cy.get(searchAssignmentsPage.CHK_SUBJECT_PHYSICS).check();
    cy.get(searchAssignmentsPage.CHK_RESOURCE_TYPE_SEQUENCE).uncheck();
    cy.get(searchAssignmentsPage.BTN_GO).click();
  ...
  it("Verify grade search filter for Math activity ", () => {
    adminHelper.openSearchMaterialsPage();
    cy.get(searchAssignmentsPage.TXT_SEARCH_BAR).type(ACTIVITY1);
    cy.get(searchAssignmentsPage.CHK_GRADE_LEVELS_5_6).check();
    cy.get(searchAssignmentsPage.CHK_GRADE_LEVELS_7_8).uncheck();
    cy.get(searchAssignmentsPage.CHK_SUBJECT_MATH).uncheck();
    cy.get(searchAssignmentsPage.CHK_SUBJECT_PHYSICS).uncheck();
    cy.get(searchAssignmentsPage.CHK_RESOURCE_TYPE_SEQUENCE).uncheck();
  ...
  it("Verify grade search filter for Physics activity", () => {
    ...
    cy.get(searchAssignmentsPage.TXT_SEARCH_BAR).type(ACTIVITY2);
    cy.get(searchAssignmentsPage.CHK_GRADE_LEVELS_5_6).uncheck();
    cy.get(searchAssignmentsPage.CHK_GRADE_LEVELS_7_8).check();
    cy.get(searchAssignmentsPage.CHK_SUBJECT_MATH).uncheck();
    cy.get(searchAssignmentsPage.CHK_SUBJECT_PHYSICS).uncheck();
    cy.get(searchAssignmentsPage.CHK_RESOURCE_TYPE_SEQUENCE).uncheck();
    cy.get(searchAssignmentsPage.BTN_GO).click();
  ...
  it("Verify sensor search filter for temperature activity ", () => {
    ...
    cy.get(searchAssignmentsPage.CHK_SUBJECT_MATH).uncheck();
    cy.get(searchAssignmentsPage.CHK_SUBJECT_PHYSICS).uncheck();
    cy.get(searchAssignmentsPage.CHK_SENSOR_TEMPERATURE).check();
    cy.get(searchAssignmentsPage.CHK_RESOURCE_TYPE_SEQUENCE).uncheck();
    cy.get(searchAssignmentsPage.BTN_GO).click();
  ...
  it("Verify sensor search filter for force activity ", () => {
    adminHelper.openSearchMaterialsPage();
    cy.get(searchAssignmentsPage.TXT_SEARCH_BAR).type(ACTIVITY4);
    cy.get(searchAssignmentsPage.CHK_SENSOR_TEMPERATURE).uncheck();
    cy.get(searchAssignmentsPage.CHK_SENSOR_FORCE).check();
    cy.get(searchAssignmentsPage.CHK_RESOURCE_TYPE_SEQUENCE).uncheck();
    cy.get(searchAssignmentsPage.BTN_GO).click();
  ...
  it("Verify sensor search filter for activity ", () => {
    ...
    cy.get(searchAssignmentsPage.TXT_SEARCH_BAR).type(ACTIVITY5);
    cy.get(searchAssignmentsPage.CHK_SENSOR_TEMPERATURE).uncheck();
    cy.get(searchAssignmentsPage.CHK_SENSOR_FORCE).uncheck();
    cy.get(searchAssignmentsPage.CHK_SENSOR_NOT_NECESSARY).check();
    cy.get(searchAssignmentsPage.CHK_RESOURCE_TYPE_SEQUENCE).uncheck();
    cy.get(searchAssignmentsPage.BTN_GO).click();
