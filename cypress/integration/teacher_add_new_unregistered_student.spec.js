...
context("Verify teacher can add a new student to a class", () => {
  ...
  it("Verify teacher is able to add new students to the class", () => {
    ...
    cy.get(studentRosterPageElements.STUDENT_ROSTER_TABLE_STUDENT_USERNAME).then(($username) => {
      STUDENT_TWO_USERNAME = $username.text(); // Get the class name of the unarchived class
    });
    ...
    cy.get(studentRosterPageElements.STUDENT_ROSTER_TABLE_STUDENT_TWO_USERNAME).then(($username) => {
      STUDENT_THREE_USERNAME = $username.text(); // Get the class name of the unarchived class
    });
  });
