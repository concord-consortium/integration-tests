...
const teacherHomePageElements = {
  ...
  LEFT_NAV_CLASSES : '#clazzes_nav li[class^=\"section\"]:nth-child(3)',
  LEFT_NAV_CLASS_NAME : '#clazzes_nav li[class^=\"section\"] li[class^=\"section\"]',
  LEFT_NAV_CLASS_ASSIGNMENTS : 'li a[\"Assignments\"]',
